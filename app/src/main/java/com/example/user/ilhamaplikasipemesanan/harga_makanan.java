package com.example.user.ilhamaplikasipemesanan;
...
public class harga_makanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harga_makanan);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Toast.makeText(harga_makanan.this, "Tersimpan!", Toast.LENGTH_SHORT).show();
